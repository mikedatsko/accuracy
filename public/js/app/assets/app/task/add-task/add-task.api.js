...
var log = Log.create('AddTaskApi()');
log.color = 'darkgreen';
var AddTaskApi = (function () {
    function AddTaskApi(http) {
        this.http = http;
        this.tasks = [];
        log.d('constructor()', API);
    }
    AddTaskApi.prototype.addTask = function (task) {
    ...
    AddTaskApi.prototype.updateTask = function (task) {
        var body = JSON.stringify(task);
        var headers = new Headers({
            'Content-Type': 'application/json'
        });
    ...
    AddTaskApi.prototype.removeTask = function (task) {
        var headers = new Headers({
            'Content-Type': 'application/json'
        });
    ...
    AddTaskApi.prototype.getTasks = function () {
        var _this = this;
...
AddTaskApi = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [Http])
], AddTaskApi);
export { AddTaskApi };
//# sourceMappingURL=add-task.api.js.map